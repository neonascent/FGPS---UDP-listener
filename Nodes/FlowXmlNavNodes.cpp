...
// FlowXmlNavNodes.cpp
//
// Purpose: Flowgraph nodes to navigating through an Xml document
//
// History:
...
public:
	...
	virtual void GetConfiguration(SFlowNodeConfig& config)
	{
		...
		{
			ADD_BASE_INPUTS(),
			InputPortConfig<string>("Name", 0, _HELP("Name of child node"), 0, 0),
...
public:
	...
	virtual void GetConfiguration(SFlowNodeConfig& config)
	{
		...
		{
			ADD_BASE_INPUTS(),
			InputPortConfig<string>("Name", 0, _HELP("Optional child name - Specify to delete all children with matching name only"), 0, 0),
			{0}
		};
